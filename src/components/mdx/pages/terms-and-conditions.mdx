<Section title="Introdução e Aceitação dos Termos">
...
<Section title="Quem pode usar a Afrodiite.com">
...
<Section title="Regras de uso do site">
...
<Section title="Publicação e remoção de anúncios">
...
<Section title="Responsabilidade da Afrodiite.com">
...
<Section title="Denúncias e contacto">
...
<Section title="Alterações nos Termos e Condições">
