...
export const Text = useStyled(TextBase, {
	...
	variants: {
		as: {
			...
			h5: { as: 'h5', className: 'text-lg' },
			h6: { as: 'h6', className: 'text-base' },
			p: { as: 'p', className: 'text-base' },
			span: { as: 'span', className: 'text-base' },
			li: { as: 'li', className: 'text-base' },
			ul: { as: 'ul', className: 'text-base' },
			ol: { as: 'ol', className: 'text-base' },
			label: { as: 'label', className: 'text-base' },
		},
